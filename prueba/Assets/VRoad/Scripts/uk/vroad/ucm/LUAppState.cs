...
namespace uk.vroad.ucm
{
    ...
    {
        // This fires in the main Unity thread, so Unity GameObjects can implement this interface and
        // register as listeners with GameStateHandler, to received forwarded state changes in the
        // main Unity thread - some operations must be executed in that thread.
